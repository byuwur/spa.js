...
(function (global) {
	...
	byCommon.initMedia = function () {
		document.querySelectorAll("video[autoplay][muted]").forEach(function (video) {
			const play = video.play?.();
			if (play && typeof play.catch === "function") play.catch(function () {});
		});
		if (document.getElementById("bywr-video-player")) byCommon.initVideo("bywr-video-player");
	};

	byCommon.afterSPALoad = function () {
	...
	document.addEventListener("byspa:load", byCommon.afterSPALoad);
